...
namespace MegamanData
{
    public unsafe class MegamanBPP
    {
        ...
        public MegamanBPP(Bitmap Bitmap)
        {
            this.bitmap = Bitmap;
        ...
        public MegamanBPP(Bitmap Bitmap, string PalFilename)
        {
            this.bitmap = Bitmap;
